	...
	*/
	...
	function categorizer_add(){
		...
		jQuery(scats.split(',')).each(function(d){
			...
			jQuery('#categories-all .selectit').each(function(d){
	...
	//]]>
		...
		<div id="adv_categorizer">
			...
			<label for="categorizer_text" class="selectit"><input type="text" id="categorizer_text" name="name" value="" style="width : 180px;" /> </label>
